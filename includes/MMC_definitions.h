...
///////////////////////////////////////////////////////////////////////////////
typedef int (*MMC_CB_FUNC)(unsigned char*, short,void*);
typedef int (*MMC_MB_CLBK)(unsigned char*, short,void*,...);//MB support to MMCPP library. @YL 27-06-2011
...
///////////////////////////////////////////////////////////////////////////////
typedef unsigned short MMC_AXIS_REF_HNDL;

///////////////////////////////////////////////////////////////////////////////
/// \typedef NC_NODE_HNDL_T
/// This type define Node index.
///////////////////////////////////////////////////////////////////////////////
typedef unsigned int NC_NODE_HNDL_T;

typedef int (*MMC_SYNC_TIMER_CB_FUNC)(void);
...
///
////////////////////////////////////////////////////////////////////////////////
MMC_LIB_API  int MMC_GetLibVersion () ;
...
///
////////////////////////////////////////////////////////////////////////////////
MMC_LIB_API  void MMC_GetLastError (IN MMC_CONNECT_HNDL hConn, OUT char* chStr, IN int iSize) ;
